...
function register() {
    ...
    if($('#registration_password').val() !== $('#repeat_password').val()){
      ...
      userPool.signUp(username, password, attributeList, null, function(err, result){
          ...
          var goHome = confirm('Sign up successful. Please check you email to verify your account.');
          //go home
          if(goHome){window.location.href = 'index.html';}
...
function validate() {
    ...
    cognitoUser.confirmRegistration(code, true, function(err, result) {
        ...
        var goHome = confirm('Account has been validated.');
        //go home
        if(goHome){window.location.href = 'index.html';}
    });
